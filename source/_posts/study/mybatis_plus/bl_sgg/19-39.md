...
- 水平分表相对垂直分表，会引入更多的复杂性，比如要求唯一的数据id该怎么处理
  ...
  - 核心思想
    ![lyx-20241126134459745](images/mypost/lyx-20241126134459745.png)
  - 
...
- 逻辑删除(主要是允许数据的恢复)
  ...
  ![lyx-20241126134500328](images/mypost/lyx-20241126134500328.png)
  ...
  - 逻辑删除
    ...
    - 结果
      ![lyx-20241126134500750](images/mypost/lyx-20241126134500750.png)

## 条件构造器

- 结构
  ![lyx-20241126134501181](images/mypost/lyx-20241126134501181.png)

  - 解释
    ![lyx-20241126134501637](images/mypost/lyx-20241126134501637.png)
...
- Wrapper条件组装
  ![lyx-20241126134502245](images/mypost/lyx-20241126134502245.png)
  ...
  - 注意 or也有优先级的参数
    ![lyx-20241126134502701](images/mypost/lyx-20241126134502701.png)
...
- 子查询
  假设需要完整下面的sql查询
  ![lyx-20241126134503190](images/mypost/lyx-20241126134503190.png)
