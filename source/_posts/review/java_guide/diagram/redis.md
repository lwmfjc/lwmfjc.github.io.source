...
3. 哨兵模式详解  
   ...
   > 先配置**主从模式**，再配置**哨兵模式**
    ...
    所有的哨兵 sentinel.conf 都是配置为监听master--> 192.168.14.101，如果主机宕机，sentinel.conf 中的配置也会自动更改为选举后的![image-20230228151217464](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/image-20230228151217464.png)
   ...
   1. Java客户端连接原理  
       ...
       ![image-20230228152739283](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/image-20230228152739283.png)
