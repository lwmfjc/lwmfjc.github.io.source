...
![img](images/mypost/lyx-20241126133742270.png)
...
1. 类加载器
   ...
   ![img](images/mypost/lyx-20241126133742795.png)
...
6. 小总结
   ![img](images/mypost/lyx-20241126133743244.png)
...
![img](images/mypost/lyx-20241126133743702.png)
...
![img](images/mypost/lyx-20241126133744117.png)
...
- 如图，可使用的内存都是零零散散的，导致大内存对象问题
  ![img](images/mypost/lyx-20241126133744574.png)
...
- 为了解决效率问题，出现了**复制**算法。将内存**按容量**划分成两等份，每次只使用其中的一块，**和survivor一样**用from和to两个指针。fromPlace存满了，就把存活对象copy到另一块toPlace上，然后交换指针内容，就解决了碎片问题
  ...
  ![img](images/mypost/lyx-20241126133745017.png)
...
![img](images/mypost/lyx-20241126133745474.png)
...
![img](images/mypost/lyx-20241126133745922.png)
