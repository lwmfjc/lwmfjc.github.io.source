...
用一个图来描述如下：
 ...
 ![image-20230220165733709](images/mypost/image-20230220165733709.png)
...
![image.png](images/mypost/20230328162539.png)
...
![image.png](images/mypost/20230328162622.png)
...
菜单管理界面设计如下：
![image.png](images/mypost/20230328162715.png)
...
![image.png](images/mypost/20230328162952.png)
...
除了给其他用户添加权限外，新权限系统同时支持了用户自主申请权限。这个模块除了常规的审批流（申请、审批、查看）等，有一个比较特别的功能，就是如何让用户能选对自己要的权限。所以在该模块的设计上，除了直接选择角色外，还支持通过菜单/数据权限点，反向选择角色，如下图：
 ...
 ![image.png](images/mypost/20230328162745.png)
