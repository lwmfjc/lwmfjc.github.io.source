...
- https://maven.apache.org/index.html
  ...
  - 各种内容
    ![image-20220703125536130](images/mypost/image-20220703125536130.png)

  - 要求
    ![image-20220703125601251](images/mypost/image-20220703125601251.png)

  - 视频用的3.6.3 ，这里下载3.8.6 （最新的，不要和电脑原配置冲突，方便学习，后续改回3.8.4）

    - 检查java home
      ![image-20220703130221750](images/mypost/image-20220703130221750.png)

      - 如果没有需要进行配置
        ![image-20220703130338025](images/mypost/image-20220703130338025.png)
      - ![image-20220703130544132](images/mypost/image-20220703130544132.png)

    - 将maven的bin目录配置到path环境变量下（这里使用的是下一节的方法，视频中没有用MAVEN_HOME，而是直接将maven的bin目录路径加到path中）
      ![image-20220703130145290](images/mypost/image-20220703130145290.png)

      ![image-20220703130115851](images/mypost/image-20220703130115851.png)

- maven解压后的目录结构 
  ![image-20220703130727240](images/mypost/image-20220703130727240.png)
...
- 目录创建
  ![image-20220703160344622](images/mypost/image-20220703160344622.png)
...
- 在Hello目录下，进行编译
  ![image-20220703160827325](images/mypost/image-20220703160827325.png)

- 使用```mvn compile```进行编译
  第一次会下载一些东西
  ![image-20220703161351385](images/mypost/image-20220703161351385.png)

- 查看target文件
  ![image-20220703161017403](images/mypost/image-20220703161017403.png)

- 进入classes执行java程序

  ```java com.bjpowernode.HelloMaven```
  ![image-20220703161429075](images/mypost/image-20220703161429075.png)
...
- 坐标组成，groupid,artifactId,version
  ![image-20220703180442092](images/mypost/image-20220703180442092.png)
...
- 坐标
  ![image-20220703181221145](images/mypost/image-20220703181221145.png)
- 坐标值的获取
  https://mvnrepository.com/ 
  ![image-20220703181311395](images/mypost/image-20220703181311395.png)
  - 例如mysql
    ![image-20220703181414505](images/mypost/image-20220703181414505.png)
  - ![image-20220703181441331](images/mypost/image-20220703181441331.png)
...
- 其他
  ![image-20220703182223670](images/mypost/image-20220703182223670.png)
