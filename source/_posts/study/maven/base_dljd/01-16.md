...
- https://maven.apache.org/index.html
  ...
  - 各种内容
    ![lyx-20241126134414568](images/mypost/lyx-20241126134414568.png)

  - 要求
    ![lyx-20241126134415121](images/mypost/lyx-20241126134415121.png)

  - 视频用的3.6.3 ，这里下载3.8.6 （最新的，不要和电脑原配置冲突，方便学习，后续改回3.8.4）

    - 检查java home
      ![lyx-20241126134415580](images/mypost/lyx-20241126134415580.png)

      - 如果没有需要进行配置
        ![lyx-20241126134416189](images/mypost/lyx-20241126134416189.png)
      - ![lyx-20241126134416670](images/mypost/lyx-20241126134416670.png)

    - 将maven的bin目录配置到path环境变量下（这里使用的是下一节的方法，视频中没有用MAVEN_HOME，而是直接将maven的bin目录路径加到path中）
      ![lyx-20241126134417147](images/mypost/lyx-20241126134417147.png)

      ![lyx-20241126134417604](images/mypost/lyx-20241126134417604.png)

- maven解压后的目录结构 
  ![lyx-20241126134418106](images/mypost/lyx-20241126134418106.png)
...
- 目录创建
  ![lyx-20241126134418658](images/mypost/lyx-20241126134418658.png)
...
- 在Hello目录下，进行编译
  ![lyx-20241126134419148](images/mypost/lyx-20241126134419148.png)

- 使用```mvn compile```进行编译
  第一次会下载一些东西
  ![lyx-20241126134419593](images/mypost/lyx-20241126134419593.png)

- 查看target文件
  ![lyx-20241126134420086](images/mypost/lyx-20241126134420086.png)

- 进入classes执行java程序

  ```java com.bjpowernode.HelloMaven```
  ![lyx-20241126134420644](images/mypost/lyx-20241126134420644.png)
...
- 坐标组成，groupid,artifactId,version
  ![lyx-20241126134421253](images/mypost/lyx-20241126134421253.png)
...
- 坐标
  ![lyx-20241126134421812](images/mypost/lyx-20241126134421812.png)
- 坐标值的获取
  https://mvnrepository.com/ 
  ![lyx-20241126134422351](images/mypost/lyx-20241126134422351.png)
  - 例如mysql
    ![lyx-20241126134422919](images/mypost/lyx-20241126134422919.png)
  - ![lyx-20241126134423454](images/mypost/lyx-20241126134423454.png)
...
- 其他
  ![lyx-20241126134423924](images/mypost/lyx-20241126134423924.png)
