...
- Java异常类层次结构图
  ![Exception](images/mypost/Exception.png)

  ![image-20221008163827798](images/mypost/image-20221008163827798.png)
...
- 介绍
  ...
  - SPI扩展实现
    ![image-20221009101411097](images/mypost/image-20221009101411097.png)
- API和SPI区别
  ![image-20221009101546801](images/mypost/image-20221009101546801.png)
...
- 序列化的目的，通过网络传输对象，或者说是将对象存储到文件系统、数据库、内存中
  ![image-20221009102741094](images/mypost/image-20221009102741094.png)
