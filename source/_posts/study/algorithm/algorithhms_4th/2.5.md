...
- 多键数组
  ...
  - 稳定性
    ...
    - 图示
      ![lyx-20241126134052174](attachments/img/lyx-20241126134052174.png)

## 我应该使用哪种排序算法

- 各种排序算法的性能特点
  ![lyx-20241126134052795](attachments/img/lyx-20241126134052795.png)
  - 快速排序是最快的通用排序算法
- 将原始类型数据排序
  一些性能优先的应用的重点可能是将数字排序，因此更合理的做法是跳过引用直接将原始数据
  类型的数据排序
- Java系统库的排序算法 java.util.Arrays.sort()
  ![lyx-20241126134053296](attachments/img/lyx-20241126134053296.png)
