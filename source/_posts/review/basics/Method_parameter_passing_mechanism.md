...
- change方法调用之前，jvm中的结构
  ![lyx-20241126133410974](attachments/img/lyx-20241126133410974.png)
...
- 方法栈帧中的数据
  ...
  ![lyx-20241126133411506](attachments/img/lyx-20241126133411506.png)

  当实参是特殊的类型时：比如String、包装类等对象，不可变，即
  ```s+="world";```
  会导致创建两个对象，如图（ Integer也是）
  ![lyx-20241126133411908](attachments/img/lyx-20241126133411908.png)
