...
- 分类
  - 本地仓库（本机）：位于自己计算机中，磁盘中某个目录
    ...
    - 可修改
      ...
      备份并编辑
      ![image-20220709111345399](images/mypost/image-20220709111345399.png)
      改成左斜杠的方式
    ...
    - 下面的资源是从maven中下载，或者用maven打包的
      ![image-20220709112015535](images/mypost/image-20220709112015535.png)
  ...
  - mvn命令需要在pom.xml所在的目录下执行
    ![image-20220709112759294](images/mypost/image-20220709112759294.png)

## 仓库的工作方式

![image-20220709112814643](images/mypost/image-20220709112814643.png)
...
- 使用单元测试
  ...
  - 注意：mvn compile的时候，会下载3.8.2的jar包
    ![image-20220709170257384](images/mypost/image-20220709170257384.png)
...
- mvn clean ，清理，删除以前生成的数据（删除target目录）
  ![image-20220709165910300](images/mypost/image-20220709165910300.png)
...
- 代码的编译
  ...
  - 测试resources插件
    ![image-20220709172307477](images/mypost/image-20220709172307477.png)
    ![image-20220709172332617](images/mypost/image-20220709172332617.png)
...
- mvn test-compile:编译命令，编译src/test/java 目录中的源文件，把生成的class拷贝到target/test-classes目录中，同时把src/test/resources目录中的文件拷贝到test-classes目录
  命令执行前
  ![image-20220709172752580](images/mypost/image-20220709172752580.png)
  执行后
  ![image-20220709172841433](images/mypost/image-20220709172841433.png)
...
- mvn test 测试命令，执行test-classes目录的程序，测试src/main/java目录中的主程序是否符合要求
  ...
  测试报告
  ![image-20220709173436937](images/mypost/image-20220709173436937.png)

  - 测试失败的情况
    ![image-20220709173514572](images/mypost/image-20220709173514572.png)
...
- mvn package 打包，作用是把项目中的资源class文件和配置文件，都放到一个压缩包中，默认压缩文件是jar类型，web应用是war类型，扩展名jar/war
  ...
  - 生成ch01-maven-1.0-SNAPSHOT.jar
    ...
    查看jar
    ![image-20220709174531640](images/mypost/image-20220709174531640.png)
...
- mvn install 
  ...
  结果
  ![image-20220709175553540](images/mypost/image-20220709175553540.png)
