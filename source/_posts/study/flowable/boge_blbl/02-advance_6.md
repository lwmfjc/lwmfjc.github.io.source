...
- 流程图绘制
  ![lyx-20241126134157207](images/mypost/lyx-20241126134157207.png)
...
- 依次完成1，2，3
  ...
  - 可以在这个表里让用户选择回退节点
    ![lyx-20241126134157762](images/mypost/lyx-20241126134157762.png)

  - 此时让user3再完成任务

  - 注：用下面的方法，不关心当前节点，只写明要跳转的结点即可
    ![lyx-20241126134158189](images/mypost/lyx-20241126134158189.png)
...
- 绘制
  ![lyx-20241126134158633](images/mypost/lyx-20241126134158633.png)
  ...
  - 查看部署的流程内置的表单
    ...
    - ![lyx-20241126134159206](images/mypost/lyx-20241126134159206.png)

  - 第一种启动方式，通过map
    ![lyx-20241126134159669](images/mypost/lyx-20241126134159669.png)
  ...
  - ```java
    ...
    - 注意查看act_ru_variable变量表
      ![lyx-20241126134200271](images/mypost/lyx-20241126134200271.png)
  ...
  - 查看完成的任务【主要】//有点问题，不管
    ![lyx-20241126134200830](images/mypost/lyx-20241126134200830.png)
