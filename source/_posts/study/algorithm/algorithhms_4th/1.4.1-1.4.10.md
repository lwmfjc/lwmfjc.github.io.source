...
- 使用计时器得到大概的运行时间
  ![lyx-20241126134031334](attachments/img/lyx-20241126134031334.png)
  ...
  - 使用方法
    ![lyx-20241126134031971](attachments/img/lyx-20241126134031971.png)
...
- 常见的增长数量级函数
  ![lyx-20241126134032481](attachments/img/lyx-20241126134032481.png)
  
- 本书用性质表示需要用实验验证的猜想
  - ThreeSum分析
    执行最频繁的指令决定了程序执行的总时间--我们将这些指令称为程序的**内循环**
  
    ![lyx-20241126134032923](attachments/img/lyx-20241126134032923.png)
  - 程序运行时间的分析
    ![lyx-20241126134033334](attachments/img/lyx-20241126134033334.png)
  - 算法的分析
...
- 成长增长的数量级一般都是问题规模N的若干函数之一，如下表
  ![lyx-20241126134033746](attachments/img/lyx-20241126134033746.png)
  - 常数级别表示运行时间不依赖于N
  - 对数级别，经典例子是**二分查找**
  - 线性级别（常见的for循环）
  ...
  - 指数级别
- 问题规模（图）
  ![lyx-20241126134034190](attachments/img/lyx-20241126134034190.png)
- 典型的增长数量级函数（图）
  ![lyx-20241126134034640](attachments/img/lyx-20241126134034640.png)
- 典型的增长数量级函数
  ![lyx-20241126134035077](attachments/img/lyx-20241126134035077.png)
- 在某个成本模型下可以提出精确的命题
...
- 将3-sum问题简化为2-sum问题，即找出一个输入文件中所有和为0的整数对的数量，为了简化问题，题设所有整数均不相同
  ...
  - 下界
    ...
    - 运行时间的总结
      ...
      图1
      ![lyx-20241126134035561](attachments/img/lyx-20241126134035561.png)
      图2
      ![lyx-20241126134035995](attachments/img/lyx-20241126134035995.png)
...
- 代码
  ...
  - 试验结果
    ![lyx-20241126134036416](attachments/img/lyx-20241126134036416.png)
  - 预测
    ![lyx-20241126134036865](attachments/img/lyx-20241126134036865.png)
  - 倍率定理（没看懂，不管）
    ![lyx-20241126134037295](attachments/img/lyx-20241126134037295.png)
    - 评估它解决大型问题的可行性
    - 评估使用更快的计算机所产生的价值
...
- 对最坏情况下的性能保证
  - 命题（这里只针对之前的代码）
    ![lyx-20241126134037717](attachments/img/lyx-20241126134037717.png)
- 对计划算法，有时候对输入需要进行打乱
- 操作序列
- 均摊分析
...
- Java的内存分配系统
- 原始数据类型的常见内存、需求
  ![lyx-20241126134038139](attachments/img/lyx-20241126134038139.png)
...
- 对象（跳过）
  ...
  - 典型对象的内存需求
    ...
    ![lyx-20241126134038654](attachments/img/lyx-20241126134038654.png)
  ...
  - 
    ...
    ![lyx-20241126134039100](attachments/img/lyx-20241126134039100.png)
  ...
  - 字符串的值和子字符串
    ...
    - 关于子字符串
      ![lyx-20241126134039586](attachments/img/lyx-20241126134039586.png)
