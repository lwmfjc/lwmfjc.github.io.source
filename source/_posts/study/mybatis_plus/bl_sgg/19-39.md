...
- 水平分表相对垂直分表，会引入更多的复杂性，比如要求唯一的数据id该怎么处理
  ...
  - 核心思想
    ![image-20220603182604230](images/mypost/image-20220603182604230.png)
  - 
...
- 逻辑删除(主要是允许数据的恢复)
  ...
  ![image-20220603234839526](images/mypost/image-20220603234839526.png)
  ...
  - 逻辑删除
    ...
    - 结果
      ![image-20220603235258702](images/mypost/image-20220603235258702.png)

## 条件构造器

- 结构
  ![image-20220603235853815](images/mypost/image-20220603235853815.png)

  - 解释
    ![image-20220603235924382](images/mypost/image-20220603235924382.png)
...
- Wrapper条件组装
  ![image-20220604110742317](images/mypost/image-20220604110742317.png)
  ...
  - 注意 or也有优先级的参数
    ![image-20220604112732422](images/mypost/image-20220604112732422.png)
...
- 子查询
  假设需要完整下面的sql查询
  ![image-20220604113152896](images/mypost/image-20220604113152896.png)
