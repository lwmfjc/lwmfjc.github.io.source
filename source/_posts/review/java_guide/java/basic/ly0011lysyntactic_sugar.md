...
![image-20221013110105262](images/mypost/image-20221013110105262.png)

int是比较数值，而char则是比较其ascii码，所以其实对于编译器来说，都是int类型(整型)，比如`byte`。`short`，`char`(ackii 码是整型)以及`int`。
![image-20221013111130070](images/mypost/image-20221013111130070.png)

![image-20221013111255889](images/mypost/image-20221013111255889.png)
而对于enum类型，  
![image-20221013111642816](images/mypost/image-20221013111642816.png)
