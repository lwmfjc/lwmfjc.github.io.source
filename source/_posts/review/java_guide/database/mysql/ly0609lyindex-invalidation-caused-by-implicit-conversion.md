...
数据如下所示：  
![img](attachments/img/lyx-20241126133521537.png)
...
下面看1234的执行计划  
![img](attachments/img/lyx-20241126133522076.png)
...
3. ★★
   ...
   3. 对第二点的后半部分再做解释  
      ...
      >
      > ![img](attachments/img/lyx-20241126133522485.png)
      ...
      ![img](attachments/img/lyx-20241126133522946.png)

      如此也就印证了之前的查询结果了

4. 再次写一条 SQL 查询 str1 字段：`SELECT * FROM`test1`WHERE str1 = 1234;`

   ![img](attachments/img/lyx-20241126133523365.png)
