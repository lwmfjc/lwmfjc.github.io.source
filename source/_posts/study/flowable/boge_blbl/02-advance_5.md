...
![image-20220515155359395](images/mypost/image-20220515155359395.png)

### 排他网关

会按照所有出口顺序流定义的顺序对它们进行计算，选择第一个条件计算为true的顺序流（**当没有设置条件时，认为顺序流为true**）继续流程

![image-20220515155535107](images/mypost/image-20220515155535107.png)

- 排他网关的绘制
  ![image-20220515161442209](images/mypost/image-20220515161442209.png)
  xml文件
...
- 运行
  ...
  - 数据库
    ![image-20220515161800379](images/mypost/image-20220515161800379.png)
...
- 此时再ran一个num为4的实例，然后张三完成，此时会走到总经理审批
  ...
  - 
    ![image-20220515162344557](images/mypost/image-20220515162344557.png)

- 注意，如果这里num设置为3，则会报错
  ![image-20220515162412014](images/mypost/image-20220515162412014.png)

- 两者区别
  ![image-20220515162512860](images/mypost/image-20220515162512860.png)
...
- 绘制流程图
  ![image-20220515163112903](images/mypost/image-20220515163112903.png)
...
- 并行网关的条件会被忽略
  ![image-20220515163308541](images/mypost/image-20220515163308541.png)
...
- 此时任务停留在zhangsan
  ![image-20220515163545652](images/mypost/image-20220515163545652.png)
...
- 查看表数据(一个任务包含多个执行实例)
  ![image-20220515163747247](images/mypost/image-20220515163747247.png)

- 让王五和李四进行审批
  查看数据库，wangwu审批后，act_ru_task就少了一条记录
  ![image-20220515164011925](images/mypost/image-20220515164011925.png)

- 此时走到总经理节点
  ![image-20220515164102982](images/mypost/image-20220515164102982.png)

- 图解
  ![image-20220515164127110](images/mypost/image-20220515164127110.png)
...
- 流程图
  ![image-20220515164830895](images/mypost/image-20220515164830895.png)
  xml
...
- 看数据，默认走人事和项目经理
  ![image-20220515165318571](images/mypost/image-20220515165318571.png)

- i1,i2所在任务执行完后，会发现走总经理
  i1走完之后
  ![image-20220515165402581](images/mypost/image-20220515165402581.png)
...
![image-20220515165548361](images/mypost/image-20220515165548361.png)
