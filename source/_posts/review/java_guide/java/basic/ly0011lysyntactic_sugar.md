...
![lyx-20241126133606021](images/mypost/lyx-20241126133606021.png)

int是比较数值，而char则是比较其ascii码，所以其实对于编译器来说，都是int类型(整型)，比如`byte`。`short`，`char`(ackii 码是整型)以及`int`。
![lyx-20241126133606686](images/mypost/lyx-20241126133606686.png)

![lyx-20241126133607111](images/mypost/lyx-20241126133607111.png)
而对于enum类型，  
![lyx-20241126133607538](images/mypost/lyx-20241126133607538.png)
