...
- 场景
  ![image-20220604141320188](images/mypost/image-20220604141320188.png)

- 乐观锁根据版本号使用 version

- 乐观锁实现流程
  ![image-20220604141615175](images/mypost/image-20220604141615175.png)
...
- 数据库数据
  ![image-20220604142342514](images/mypost/image-20220604142342514.png)
...
- 数据库增加一个sex 字段，实体类增加一个sex属性
  ![image-20220604163208649](images/mypost/image-20220604163208649.png)
...
{% post_link study/mybatis_plus/official/hello  在28%进度的地方 %}
  ...
  - mybatis-plus 代码自动生成
    ...
    - 在测试类中编写程序让其自动生成
      ...
      - shang gui gu 配置
        ![image-20220604165408694](images/mypost/image-20220604165408694.png)
      
      ![image-20220604165451088](images/mypost/image-20220604165451088.png)
...
- 新建一个mybatis-plus数据库和表
  ![image-20220604170202852](images/mypost/image-20220604170202852.png)
...
- 代码
  ...
  - 结构
    ![image-20220604173324836](images/mypost/image-20220604173324836.png)
    ![image-20220604173357652](images/mypost/image-20220604173357652.png)

## 安装MyBatisX插件

- 插件市场
  ![image-20220604173502957](images/mypost/image-20220604173502957.png)
- 自动定位
  ![image-20220604173533155](images/mypost/image-20220604173533155.png)

## MyBatis代码快速生成

- 配置
  ![image-20220604173606015](images/mypost/image-20220604173606015.png)
- url及密码配置
  ![image-20220604173630815](images/mypost/image-20220604173630815.png)
- 使用
  ![image-20220604173659189](images/mypost/image-20220604173659189.png)
- ![image-20220604173710148](images/mypost/image-20220604173710148.png)
- 自动生成
  ![image-20220604173748997](images/mypost/image-20220604173748997.png)
- ![image-20220604173807772](images/mypost/image-20220604173807772.png)
