...
- 对象的构成元素（what）
  ...
  ![lyx-20241126133701340](images/mypost/lyx-20241126133701340.png)
  - 对象头（Header）
    - **对象标记 MarkWord**
...
- 对象标记 
    ...
    ![lyx-20241126133701924](images/mypost/lyx-20241126133701924.png)

    1. 如果在64位系统中，对象头中，**mark word（对象标记）**占用8个字节（64位）；**class pointer（类元信息）**占用8个字节，总共16字节（忽略压缩指针）
    2. 无锁的时候，
       ![lyx-20241126133702352](images/mypost/lyx-20241126133702352.png)

- 类型指针
    注意下图，指向方法区中（模板）的地址
    ![lyx-20241126133702786](images/mypost/lyx-20241126133702786.png)
...
![lyx-20241126133703210](images/mypost/lyx-20241126133703210.png)

## 具体的（64位虚拟机为主）

![lyx-20241126133703631](images/mypost/lyx-20241126133703631.png)
...
源码中  
![lyx-20241126133704188](images/mypost/lyx-20241126133704188.png)
...
- java 运行中添加参数 -XX:MaxTenuringThreshold = 16 ，则会出现下面错误，即分代gc最大年龄为15
  ![lyx-20241126133704755](images/mypost/lyx-20241126133704755.png)

- 压缩指针的相关说明

  - 使用 java -XX:+PrintComandLineFlags -version ，打印参数

    ![lyx-20241126133705221](images/mypost/lyx-20241126133705221.png)
