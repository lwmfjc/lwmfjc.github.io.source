...
- Java异常类层次结构图
  ![lyx-20241126133556644](images/mypost/lyx-20241126133556644.png)

  ![lyx-20241126133557180](images/mypost/lyx-20241126133557180.png)
...
- 介绍
  ...
  - SPI扩展实现
    ![lyx-20241126133557582](images/mypost/lyx-20241126133557582.png)
- API和SPI区别
  ![lyx-20241126133558068](images/mypost/lyx-20241126133558068.png)
...
- 序列化的目的，通过网络传输对象，或者说是将对象存储到文件系统、数据库、内存中
  ![lyx-20241126133558485](images/mypost/lyx-20241126133558485.png)
