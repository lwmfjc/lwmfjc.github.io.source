...
用一个图来描述如下：
 ...
 ![lyx-20241126133846805](attachments/img/lyx-20241126133846805.png)
...
![image.png](attachments/img/lyx-20241126133847338.png)
...
![image.png](attachments/img/lyx-20241126133847836.png)
...
菜单管理界面设计如下：
![image.png](attachments/img/lyx-20241126133848319.png)
...
![image.png](attachments/img/lyx-20241126133848837.png)
...
除了给其他用户添加权限外，新权限系统同时支持了用户自主申请权限。这个模块除了常规的审批流（申请、审批、查看）等，有一个比较特别的功能，就是如何让用户能选对自己要的权限。所以在该模块的设计上，除了直接选择角色外，还支持通过菜单/数据权限点，反向选择角色，如下图：
 ...
 ![image.png](attachments/img/lyx-20241126133849267.png)
