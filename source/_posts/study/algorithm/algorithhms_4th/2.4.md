...
- 泛型优先队列的API
  ![image-20220530231019846](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/image-20220530231019846.png)

- 优先队列的调用示例
  从N各输入中找到最大的M各元素所需成本
  ![image-20220530231059427](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/image-20220530231059427.png)
  ...
  - 应用
    ![image-20220530231154665](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/image-20220530231154665.png)
...
- 优先队列的各种实现在最坏情况下运行时间的增长数量级
  ![image-20220530231218833](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/image-20220530231218833.png)
- 在一个优先队列上执行的一系列操作如表2.4.4所示
  ![image-20220530231233202](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/image-20220530231233202.png)
...
- 图解
  ![image-20220530231408925](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/image-20220530231408925.png)

  ![image-20220530231421881](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/image-20220530231421881.png)
...
- 堆实现的比较和交换方法
  ...
  - 图解堆的操作
    ![image-20220530231448254](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/image-20220530231448254.png)
  ...
  - 说明
    ...
    - 在堆上进行操作
      ![image-20220530231507695](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/image-20220530231507695.png)
  ...
  - 索引优先队列
    ...
    ![image-20220530231606619](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/image-20220530231606619.png)
    ![image-20220530231629490](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/image-20220530231629490.png)
...
- 堆排序的轨迹（每次下沉后的数组内容）
  ![image-20220530231711247](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/image-20220530231711247.png)

- 堆排序：堆的构造（左）和下沉排序（右）
  ![image-20220530231727650](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/image-20220530231727650.png)
