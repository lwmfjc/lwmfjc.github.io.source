...
- `@ComponentScan`： 扫描被`@Component` (`@Service`,`@Controller`)注解的 bean，注解默认会扫描启动类所在的包下所有的类 ，可以自定义不扫描某些 bean。如下图所示，容器中将排除`TypeExcludeFilter`和`AutoConfigurationExcludeFilter`。
  ...
  ![img](images/mypost/6WLR66zo9Ecr10hSi.jpg)
...
![img](images/mypost/XQn7XRreqWrg6kZLl.jpg)
...
![img](images/mypost/I97OCsLrppvbvPmGi.jpg)

**第 2 步** ：

用于获取`EnableAutoConfiguration`注解中的 `exclude` 和 `excludeName`。

![img](images/mypost/0GkrisEhrnCKwEZRx.jpg)
...
[![img](images/mypost/AyDsNFGeRTKXY2nwV.jpg)
...
[![img](images/mypost/euunL1tKEb13j5Vmj.jpg)](https://camo.githubusercontent.)
...
![img](images/mypost/i60JPdF2F9uVwnqtG.jpg) 

第二步，引入 Spring Boot 相关依赖

[![img](images/mypost/iCiw55T1l7Y0fjIoG.jpg) 

第三步，创建`ThreadPoolAutoConfiguration`

 ![img](images/mypost/AMK0ZH33v7bCziCzT.jpg) 
...
[![img](images/mypost/oB9CBRHyrlp9usEK4.jpg) 
