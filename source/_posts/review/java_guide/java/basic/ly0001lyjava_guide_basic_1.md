...
- 字节码，采用字节码的好处
  ...
  - Java程序从源代码到运行的过程
    ![image-20220928110902410](images/mypost/image-20220928110902410.png)
...
- 编译与解释并存
  ...
  - 如图
    ![image-20220928110844996](images/mypost/image-20220928110844996.png)
...
- 注释分为 单行注释、多行注释、文档注释
  ![image-20220928111257144](images/mypost/image-20220928111257144.png)
...
- 包装类型的缓存机制
  ...
  - 如上，所有整型包装类对象之间值的比较，应该全部使用equals方法比较
    ![image-20220929092643596](images/mypost/image-20220929092643596.png)
  ...
  - 超过long整形的数据，使用BigInteger
    ...
    ![image-20220929093558353](images/mypost/image-20220929093558353.png)