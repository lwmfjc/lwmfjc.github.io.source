...
思维导图  
![img](images/mypost/1.af0577dc.png)
...
![image-20221206091635103](images/mypost/image-20221206091635103.png)
...
>
> ![image-20221206092433827](images/mypost/image-20221206092433827.png)
...
>
> ![image-20221206094304751](images/mypost/image-20221206094304751.png)
>
> ---
>
> ```java
...
![image-20221206095002176](images/mypost/image-20221206095002176.png)
...
gc之后的图：  
![img](images/mypost/3.a63c3de1.png)
...
![img](images/mypost/4.c4285c13.png)
...
![img](images/mypost/5.deed12c8.png)
...
如图所示  
![image-20221206134817533](images/mypost/image-20221206134817533.png)
...
例子如下，产生的哈希码分布十分均匀  
![image-20221206135759498](images/mypost/image-20221206135759498.png)
...
- ThreadLocalMap中没有链表结构（使用**线性向后查找**）
  - 如图
    ![img](images/mypost/7.5b9136ff.png)
...
4. 清理后如果大于 threshold 的3/4 ，则进行扩容
   ![img](images/mypost/24.ec7f7610.png)
...
1.  通过查找`key`值计算出散列表中`slot`位置，然后该`slot`位置中的`Entry.key`和查找的`key`一致，则直接返回
   ![img](images/mypost/26.ff0553de.png)

2. `slot`位置中的`Entry.key`和要查找的`key`不一致，之后**清理**+**遍历**
   ![img](images/mypost/27.9c78c2a2.png)
   ...
   > ![img](images/mypost/28.ea7d5196.png)
