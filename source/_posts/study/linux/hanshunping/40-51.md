...
- 使用chown root helo.java 修改，效果如下
  ![lyx-20241126134338848](attachments/img/lyx-20241126134338848.png)
...
- 注意逻辑，此时使用fox创建文件
  passwd fox 给fox创建密码
- 如图，创建一个文件
  ![lyx-20241126134339424](attachments/img/lyx-20241126134339424.png)
- 使用chgrp fruit orange.txt
  修改文件的所在组
  ![lyx-20241126134339868](attachments/img/lyx-20241126134339868.png)
- 改变某个用户所在组
  usermod -g fruit fox
  ![lyx-20241126134340285](attachments/img/lyx-20241126134340285.png)
...
- 
  ![lyx-20241126134340691](attachments/img/lyx-20241126134340691.png)
  - 最后面的数字，代表连接数（或者子目录数）
...
题目
![lyx-20241126134341155](attachments/img/lyx-20241126134341155.png)
