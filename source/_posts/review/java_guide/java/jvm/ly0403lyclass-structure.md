...
![lyx-20241126133726527](attachments/img/lyx-20241126133726527.png)
...
![lyx-20241126133727114](attachments/img/lyx-20241126133727114.png)

通过IDEA插件jclasslib查看，可以直观看到```Class 文件结构```

![img](attachments/img/lyx-20241126133727583.png)
...
![lyx-20241126133728067](attachments/img/lyx-20241126133728067.png)
...
1. 字面量比较接近于Java语言层面的**常量概念**，如**文本字符串**、**声明为final的常量值**等
   ...
   > 注意，**非常量**是不会在这里的，
   > ![lyx-20241126133728490](attachments/img/lyx-20241126133728490.png)
   >
   > 没有找到3 
...
![lyx-20241126133728943](attachments/img/lyx-20241126133728943.png)
...
【这里好像漏了一个0x0002 ，private 】![lyx-20241126133729433](attachments/img/lyx-20241126133729433.png)

> ![img](attachments/img/lyx-20241126133729891.jpg)
>
...
![查看类的访问标志](attachments/img/lyx-20241126133730371.png)
...
- 字段包括**类级变量**以及**实例变量**，但不包括在**方法内部**声明的局部变量
  filed info(字段表)的结构：  
  ![lyx-20241126133730905](attachments/img/lyx-20241126133730905.png)
  ...
  ![字段的 access_flag 的取值](attachments/img/lyx-20241126133731382.png)
...
- **method_info（方法表的）结构**  
  ![方法表的结构](attachments/img/lyx-20241126133732024.png)
  **方法表的 access_flag 取值：**
  ![方法表的 access_flag 取值](attachments/img/lyx-20241126133732512.png)
...
**如上，字段和方法都拥有属性**
属性大概就是这种
![lyx-20241126133733098](attachments/img/lyx-20241126133733098.png)
