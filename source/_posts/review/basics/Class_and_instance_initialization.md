...
- 类初始化过程
  ...
  - 类初始化执行的是<clinit >方法，编译查看字节码可得知
    ![lyx-20241126133406187](images/mypost/lyx-20241126133406187.png)
  - <clinit >由静态类变量显示赋值语句 以及 静态代码块组成(由上到下顺序)，且只执行一次  
    如下  
    ![lyx-20241126133406673](images/mypost/lyx-20241126133406673.png)
...
- 实例初始化过程
  ...
  - 执行的是<init>方法
    ...
    4) 子类的无参构造(最后)  
    ![lyx-20241126133407112](images/mypost/lyx-20241126133407112.png)
