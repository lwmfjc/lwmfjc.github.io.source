...
![lyx-20241126134149323](images/mypost/lyx-20241126134149323.png)

### 排他网关

会按照所有出口顺序流定义的顺序对它们进行计算，选择第一个条件计算为true的顺序流（**当没有设置条件时，认为顺序流为true**）继续流程

![lyx-20241126134149855](images/mypost/lyx-20241126134149855.png)

- 排他网关的绘制
  ![lyx-20241126134150292](images/mypost/lyx-20241126134150292.png)
  xml文件
...
- 运行
  ...
  - 数据库
    ![lyx-20241126134150709](images/mypost/lyx-20241126134150709.png)
...
- 此时再ran一个num为4的实例，然后张三完成，此时会走到总经理审批
  ...
  - 
    ![lyx-20241126134151136](images/mypost/lyx-20241126134151136.png)

- 注意，如果这里num设置为3，则会报错
  ![lyx-20241126134151545](images/mypost/lyx-20241126134151545.png)

- 两者区别
  ![lyx-20241126134151992](images/mypost/lyx-20241126134151992.png)
...
- 绘制流程图
  ![lyx-20241126134152427](images/mypost/lyx-20241126134152427.png)
...
- 并行网关的条件会被忽略
  ![lyx-20241126134152877](images/mypost/lyx-20241126134152877.png)
...
- 此时任务停留在zhangsan
  ![lyx-20241126134153331](images/mypost/lyx-20241126134153331.png)
...
- 查看表数据(一个任务包含多个执行实例)
  ![lyx-20241126134153783](images/mypost/lyx-20241126134153783.png)

- 让王五和李四进行审批
  查看数据库，wangwu审批后，act_ru_task就少了一条记录
  ![lyx-20241126134154198](images/mypost/lyx-20241126134154198.png)

- 此时走到总经理节点
  ![lyx-20241126134154619](images/mypost/lyx-20241126134154619.png)

- 图解
  ![lyx-20241126134155032](images/mypost/lyx-20241126134155032.png)
...
- 流程图
  ![lyx-20241126134155444](images/mypost/lyx-20241126134155444.png)
  xml
...
- 看数据，默认走人事和项目经理
  ![lyx-20241126134155909](images/mypost/lyx-20241126134155909.png)

- i1,i2所在任务执行完后，会发现走总经理
  i1走完之后
  ![lyx-20241126134156305](images/mypost/lyx-20241126134156305.png)
...
![lyx-20241126134156752](images/mypost/lyx-20241126134156752.png)
