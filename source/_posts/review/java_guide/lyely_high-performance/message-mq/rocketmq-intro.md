...
> 原理  ![image-20230224105818739](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/image-20230224105818739.png)
>
...
![image-20230224172544599](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/image-20230224172544599.png)
...
- `Broker`： 主要负责消息的**存储**、**投递**和**查询**以及服务**高可用**保证。说白了就是**消息队列服务器嘛**，生产者生产消息到 `Broker` ，消费者从 `Broker` 拉取消息并消费。
  ...
  **一个 `Topic` 分布在多个 `Broker`上，一个 `Broker` 可以配置多个 `Topic` ，它们是多对多的关系**。
  ...
  ![image-20230225092609875](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/image-20230225092609875.png)
...
![image.png](https://raw.githubusercontent.com/lwmfjc/lwmfjc.github.io.resource/main/img/20230324112906.png)
