...
- 场景
  ![lyx-20241126134503639](images/mypost/lyx-20241126134503639.png)

- 乐观锁根据版本号使用 version

- 乐观锁实现流程
  ![lyx-20241126134504176](images/mypost/lyx-20241126134504176.png)
...
- 数据库数据
  ![lyx-20241126134504605](images/mypost/lyx-20241126134504605.png)
...
- 数据库增加一个sex 字段，实体类增加一个sex属性
  ![lyx-20241126134505053](images/mypost/lyx-20241126134505053.png)
...
{% post_link study/mybatis_plus/official/hello  在28%进度的地方 %}
  ...
  - mybatis-plus 代码自动生成
    ...
    - 在测试类中编写程序让其自动生成
      ...
      - shang gui gu 配置
        ![lyx-20241126134505531](images/mypost/lyx-20241126134505531.png)
      
      ![lyx-20241126134505978](images/mypost/lyx-20241126134505978.png)
...
- 新建一个mybatis-plus数据库和表
  ![lyx-20241126134506400](images/mypost/lyx-20241126134506400.png)
...
- 代码
  ...
  - 结构
    ![lyx-20241126134506826](images/mypost/lyx-20241126134506826.png)
    ![lyx-20241126134507232](images/mypost/lyx-20241126134507232.png)

## 安装MyBatisX插件

- 插件市场
  ![lyx-20241126134507704](images/mypost/lyx-20241126134507704.png)
- 自动定位
  ![lyx-20241126134508165](images/mypost/lyx-20241126134508165.png)

## MyBatis代码快速生成

- 配置
  ![lyx-20241126134508596](images/mypost/lyx-20241126134508596.png)
- url及密码配置
  ![lyx-20241126134509023](images/mypost/lyx-20241126134509023.png)
- 使用
  ![lyx-20241126134509478](images/mypost/lyx-20241126134509478.png)
- ![lyx-20241126134509904](images/mypost/lyx-20241126134509904.png)
- 自动生成
  ![lyx-20241126134510335](images/mypost/lyx-20241126134510335.png)
- ![lyx-20241126134510807](images/mypost/lyx-20241126134510807.png)
