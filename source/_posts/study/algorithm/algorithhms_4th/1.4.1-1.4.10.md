...
- 使用计时器得到大概的运行时间
  ![image-20220407113311126](images/mypost/image-20220407113311126.png)
  ...
  - 使用方法
    ![image-20220407113407342](images/mypost/image-20220407113407342.png)
...
- 常见的增长数量级函数
  ![image-20220407170444747](images/mypost/image-20220407170444747.png)
  
- 本书用性质表示需要用实验验证的猜想
  - ThreeSum分析
    执行最频繁的指令决定了程序执行的总时间--我们将这些指令称为程序的**内循环**
  
    ![image-20220407170842908](images/mypost/image-20220407170842908.png)
  - 程序运行时间的分析
    ![image-20220407170938405](images/mypost/image-20220407170938405.png)
  - 算法的分析
...
- 成长增长的数量级一般都是问题规模N的若干函数之一，如下表
  ![image-20220408091530468](images/mypost/image-20220408091530468.png)
  - 常数级别表示运行时间不依赖于N
  - 对数级别，经典例子是**二分查找**
  - 线性级别（常见的for循环）
  ...
  - 指数级别
- 问题规模（图）
  ![image-20220408092436213](images/mypost/image-20220408092436213.png)
- 典型的增长数量级函数（图）
  ![image-20220408092500239](images/mypost/image-20220408092500239.png)
- 典型的增长数量级函数
  ![image-20220408092659849](images/mypost/image-20220408092659849.png)
- 在某个成本模型下可以提出精确的命题
...
- 将3-sum问题简化为2-sum问题，即找出一个输入文件中所有和为0的整数对的数量，为了简化问题，题设所有整数均不相同
  ...
  - 下界
    ...
    - 运行时间的总结
      ...
      图1
      ![image-20220408095417424](images/mypost/image-20220408095417424.png)
      图2
      ![image-20220408095509262](images/mypost/image-20220408095509262.png)
...
- 代码
  ...
  - 试验结果
    ![image-20220408112657967](images/mypost/image-20220408112657967.png)
  - 预测
    ![image-20220408112708320](images/mypost/image-20220408112708320.png)
  - 倍率定理（没看懂，不管）
    ![image-20220408112746465](images/mypost/image-20220408112746465.png)
    - 评估它解决大型问题的可行性
    - 评估使用更快的计算机所产生的价值
...
- 对最坏情况下的性能保证
  - 命题（这里只针对之前的代码）
    ![image-20220408113444176](images/mypost/image-20220408113444176.png)
- 对计划算法，有时候对输入需要进行打乱
- 操作序列
- 均摊分析
...
- Java的内存分配系统
- 原始数据类型的常见内存、需求
  ![image-20220408113805644](images/mypost/image-20220408113805644.png)
...
- 对象（跳过）
  ...
  - 典型对象的内存需求
    ...
    ![image-20220408114020688](images/mypost/image-20220408114020688.png)
  ...
  - 
    ...
    ![image-20220408114325192](images/mypost/image-20220408114325192.png)
  ...
  - 字符串的值和子字符串
    ...
    - 关于子字符串
      ![image-20220408151726265](images/mypost/image-20220408151726265.png)
