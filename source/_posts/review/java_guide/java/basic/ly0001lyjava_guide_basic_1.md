...
- 字节码，采用字节码的好处
  ...
  - Java程序从源代码到运行的过程
    ![lyx-20241126133553180](images/mypost/lyx-20241126133553180.png)
...
- 编译与解释并存
  ...
  - 如图
    ![lyx-20241126133553312](images/mypost/lyx-20241126133553312.png)
...
- 注释分为 单行注释、多行注释、文档注释
  ![lyx-20241126133553770](images/mypost/lyx-20241126133553770.png)
...
- 包装类型的缓存机制
  ...
  - 如上，所有整型包装类对象之间值的比较，应该全部使用equals方法比较
    ![lyx-20241126133554177](images/mypost/lyx-20241126133554177.png)
  ...
  - 超过long整形的数据，使用BigInteger
    ...
    ![lyx-20241126133554754](images/mypost/lyx-20241126133554754.png)