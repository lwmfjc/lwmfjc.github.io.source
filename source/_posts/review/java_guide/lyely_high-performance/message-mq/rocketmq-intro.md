...
我来举个🌰吧，比如我们有一个购票系统，需求是用户在购买完之后能接收到购买完成的短信。
 ...
 ![img](attachments/img/lyx-20241126133944741.jpg)
...
![img](attachments/img/lyx-20241126133945341.jpg)
...
![img](attachments/img/lyx-20241126133945782.jpg)
...
![img](attachments/img/lyx-20241126133946235.jpg)

那么第二步，我们又添加了一个发送邮件，我们就得重新去修改代码，如果我们又加一个需求：用户购买完还需要给他加积分，这个时候我们是不是又得改代码？

![img](attachments/img/lyx-20241126133946693.jpg)

如果你觉得还行，那么我这个时候不要发邮件这个服务了呢，我是不是又得改代码，又得重启应用？

 ![lyx-20241126133947143](attachments/img/lyx-20241126133947143.png)
...
![img](attachments/img/lyx-20241126133947548.jpg)
...
我们再次回到一开始我们使用同步调用系统的情况，并且思考一下，如果此时有大量用户请求购票整个系统会变成什么样？
 ...
 ![lyx-20241126133948007](attachments/img/lyx-20241126133948007.png)
...
![img](attachments/img/lyx-20241126133948487.png)

别急，办法总是有的。

## [#](#rocketmq是什么) RocketMQ是什么？

> 原理  ![lyx-20241126133948952](attachments/img/lyx-20241126133948952.png)
>
...
![img](attachments/img/lyx-20241126133949385.jpg)
...
![img](attachments/img/lyx-20241126133949868.jpg)
...
![lyx-20241126133950309](attachments/img/lyx-20241126133950309.png)
...
![img](attachments/img/lyx-20241126133950742.jpg)
...
![img](attachments/img/lyx-20241126133951328.jpg)

可能你还有一个问题，**为什么一个主题中需要维护多个队列** ？

答案是 **提高并发能力** 。的确，每个主题中只存在一个队列也是可行的。你想一下，如果每个主题中只存在一个队列，这个队列中也维护着每个消费者组的消费位置，这样也可以做到 **发布订阅模式** 。如下图。

![img](attachments/img/lyx-20241126133951932.jpg)
...
![lyx-20241126133952419](attachments/img/lyx-20241126133952419.png)
...
- `Broker`： 主要负责消息的**存储**、**投递**和**查询**以及服务**高可用**保证。说白了就是**消息队列服务器嘛**，生产者生产消息到 `Broker` ，消费者从 `Broker` 拉取消息并消费。
  ...
  **一个 `Topic` 分布在多个 `Broker`上，一个 `Broker` 可以配置多个 `Topic` ，它们是多对多的关系**。
  ...
  ![lyx-20241126133952872](attachments/img/lyx-20241126133952872.png)
...
![img](attachments/img/lyx-20241126133953298.jpg)
...
![img](attachments/img/lyx-20241126133953713.jpg)
...
![img](attachments/img/lyx-20241126133954203.jpg)
...
![img](attachments/img/lyx-20241126133954641.png)
...
![image.png](attachments/img/lyx-20241126133955115.png)
...
![img](attachments/img/lyx-20241126133955546.jpg)
...
![img](attachments/img/lyx-20241126133955989.jpg)
...
![img](attachments/img/lyx-20241126133956412.jpg)
