...
## 基础介绍  
* 本套课程内容   
  ![](images/mypost/lyx-20241126134256317.png)
...
![](images/mypost/lyx-20241126134256886.png)
...
* Linux和Unix关系  
![](images/mypost/lyx-20241126134257327.png)
## VMWare安装Centos7.6
在windows中安装Linux系统  
* VM和Linux系统在pc中的关系  
![](images/mypost/lyx-20241126134257782.png)
* 安装过程中，网络模式使用NAT模式
* 选择最小安装，且选择CompatibilityLibraries和DevelopmentTools  
![](images/mypost/lyx-20241126134258202.png)
* linux分区  
一般分为三个  
![](images/mypost/lyx-20241126134258611.png)  
一般boot1G,swap分区一般跟内存大小一致，这里是2G，所以根分区就是剩下的，也就是20-1-2=17G  
如图，boot，/，swap都是标准分区。且boot和/是ext4的文件格式，swap是swap的文件格式  
![](images/mypost/lyx-20241126134259282.png)  
* 修改主机名  
![](images/mypost/lyx-20241126134259755.png)
* 修改密码及增加除root外的普通用户
* 修改网络为固定ip(NAT模式下)
  * 先在VM里面把子网ip改了，这里改成
  192.168.200.0  
  ![](images/mypost/lyx-20241126134300195.png)
  * 然后改网关为192.168.200.200  
  ![](images/mypost/lyx-20241126134300644.png)
