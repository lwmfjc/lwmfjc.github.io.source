...
- 流程图设计
  ...
  - 总体
    ![image-20220515143002689](images/mypost/image-20220515143002689.png)
  - 具体
    ![image-20220515142952857](images/mypost/image-20220515142952857.png)
...
- 查看数据库表数据
  ...
  - 处理人为空
    ![image-20220515144843249](images/mypost/image-20220515144843249.png)
  - 变量
    ![image-20220515144901217](images/mypost/image-20220515144901217.png)
  - 图解
    ![image-20220515144943769](images/mypost/image-20220515144943769.png)
...
- 拾取任务
  ...
  - 数据库数据
    ![image-20220515145820087](images/mypost/image-20220515145820087.png)
  - 此时查询李四候选任务，就查询不到了
...
- 归还任务
  ...
  - 数据库数据
    ![image-20220515150149037](images/mypost/image-20220515150149037.png)
  - 此时用李四，拾取成功
    ![image-20220515150352270](images/mypost/image-20220515150352270.png)
...
- 任务交接(委托)
  ...
  - 结果
    ![image-20220515150637180](images/mypost/image-20220515150637180.png)
...
- 此时任务给wz了
  ![image-20220515150842118](images/mypost/image-20220515150842118.png)
...
- 维护用户和组
  ...
  - 表结构
    ...
    ![image-20220515152203278](images/mypost/image-20220515152203278.png)

    ![image-20220515152221653](images/mypost/image-20220515152221653.png)
    ![image-20220515152232911](images/mypost/image-20220515152232911.png)

- 应用，创建流程图
  ![image-20220515152724439](images/mypost/image-20220515152724439.png)
  ![image-20220515152756047](images/mypost/image-20220515152756047.png)
...
- 表
  ![image-20220515153509046](images/mypost/image-20220515153509046.png)
  variables
  ![image-20220515153549630](images/mypost/image-20220515153549630.png)
...
- 查找当前用户所在组的任务，并拾取
  ...
  - 数据库数据
    ![image-20220515154857421](images/mypost/image-20220515154857421.png)
