...
![](images/mypost/lyx-20241126134614622.png)  
### 列表 (List)  
* 单键多值  
* 底层是双向链表  
* 从左放 
  ...
  ```
* lpush:  
![](images/mypost/lyx-20241126134615182.png)  
* 从右放  
  ``` 
  rpush k2 v1 v2 v3 
  ```
* brpush:  
![](images/mypost/lyx-20241126134615621.png)  
* lpop/rpop  
  ``` 
  lpop k2 #从左边弹出一个值
...
* linsert 
  ...
  ```
  ![](images/mypost/lyx-20241126134616062.png)
* lrem,lset
  ``` 
...
![](images/mypost/lyx-20241126134616549.png)
### 集合(Set)
* 特点：无序，不重复  
...
![](images/mypost/lyx-20241126134616991.png)  
* 常用命令
  ``` 
...
* zset底层数据结构
  * hash结构  
  ![](images/mypost/lyx-20241126134617502.png)
  * 跳跃表
  给元素value排序，根据score的范围获取元素列表
  * 对比有序链表和跳跃表  
    * 查找51元素  
    ![](images/mypost/lyx-20241126134617928.png)
    * 跳跃表  
    按图中的顺序查找，查找四次就能找到  
    ![](images/mypost/lyx-20241126134618348.png)
* End