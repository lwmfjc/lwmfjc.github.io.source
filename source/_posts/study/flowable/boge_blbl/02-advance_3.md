...
- 首先绘制流程图（定义）
  ![lyx-20241126134128771](attachments/img/lyx-20241126134128771.png)

  - 变量处理
    ![lyx-20241126134129328](attachments/img/lyx-20241126134129328.png)
    ![lyx-20241126134129723](attachments/img/lyx-20241126134129723.png)
...
- 流程的启动（在流程启动时就已经处理好了各个节点的处理人）
  ...
  - 查看数据库表数据
    ...
    - act_ru_variable
      ...
      ![lyx-20241126134130142](attachments/img/lyx-20241126134130142.png)![lyx-20241126134130570](attachments/img/lyx-20241126134130570.png)
    
    - act_ru_task
      ![lyx-20241126134130987](attachments/img/lyx-20241126134130987.png)
  ...
  - 此时观察task和identity这两张表
    ...
    任务变成了李四，而identity多了张三的记录![lyx-20241126134131419](attachments/img/lyx-20241126134131419.png)
...
- xml定义中任务监听器的配置(两个节点都配置了)
  ![lyx-20241126134131911](attachments/img/lyx-20241126134131911.png)
...
- 控制台查看
  ![lyx-20241126134132357](attachments/img/lyx-20241126134132357.png)

- 数据库查看
  ![lyx-20241126134132787](attachments/img/lyx-20241126134132787.png)
  ![lyx-20241126134133209](attachments/img/lyx-20241126134133209.png)
...
- 数据库查看
  ![lyx-20241126134133651](attachments/img/lyx-20241126134133651.png)
...
- 一个流程定义，可以运行多个流程实例；
  ![lyx-20241126134134049](attachments/img/lyx-20241126134134049.png)
  ![lyx-20241126134134493](attachments/img/lyx-20241126134134493.png)
  当用到子流程时，就会出现一对多的关系
  ![lyx-20241126134134932](attachments/img/lyx-20241126134134932.png)

- 全局变量被重复赋值时后面会覆盖前面

- 流程图的创建
  ![lyx-20241126134135546](attachments/img/lyx-20241126134135546.png)
...
- 下面修改num的值，修改之前
  ![lyx-20241126134135979](attachments/img/lyx-20241126134135979.png)
  ...
  - 结果
    ...
    ![lyx-20241126134136579](attachments/img/lyx-20241126134136579.png)
...
- 局部变量的再次测试
  ...
  - 修改前
    ![lyx-20241126134137032](attachments/img/lyx-20241126134137032.png)
  - 修改后
    ![lyx-20241126134137526](attachments/img/lyx-20241126134137526.png)
    - 结果表明这是批量增加/修改，而不是覆盖

- 当前数据库的数据 1个局部变量num，5个全局变量
  ![lyx-20241126134138056](attachments/img/lyx-20241126134138056.png)
...
- 这时李四设置了一个局部变量num=6
  ...
  仅仅多了一条记录
  ![lyx-20241126134138496](attachments/img/lyx-20241126134138496.png)
...
- 结果如下，**当局部变量和全局变量的名称一样时，只能修改局部变量**
  ![lyx-20241126134138907](attachments/img/lyx-20241126134138907.png)
...
- 注意，这里全局变量被改成20了，局部变量被删除了
  ![lyx-20241126134139354](attachments/img/lyx-20241126134139354.png)
  走到了总经理审批
...
- 再测试
  ...
  现在在赵四节点，局部变量为
  ![lyx-20241126134139779](attachments/img/lyx-20241126134139779.png)
...
- 现在只能通过在complete中设置，来使得全局变量生效
  ...
  - 结果，全局变量设置成功，且任务流转到了财务那
    ![lyx-20241126134140243](attachments/img/lyx-20241126134140243.png)
...
- 再测试
  ...
  - 在complete中加上map参数，验证明线条查找的是全局变量的值，complete带上variables会设置全局变量
    ...
    - 数据库表
      ![lyx-20241126134140651](attachments/img/lyx-20241126134140651.png)
