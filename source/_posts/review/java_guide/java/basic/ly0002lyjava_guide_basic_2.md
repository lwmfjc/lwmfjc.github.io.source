...
- 深拷贝和浅拷贝的区别？什么是引用拷贝
  ...
  - 如图  
    ![lyx-20241126133555195](images/mypost/lyx-20241126133555195.png)
...
- 字符串使用“+” 还是 Stringbuilder 
  ...
  对应的字节码：  
  ![lyx-20241126133555737](images/mypost/lyx-20241126133555737.png)
...
- 字符串常量池  
  ...
  - ####  String s1 = new String("abc");这句话创建了几个字符串对象？
    ...
    下面这个解释，说明**常量池存储的是引用**（堆中某一块区域的）![lyx-20241126133556182](images/mypost/lyx-20241126133556182.png)
