...
- 什么是进程和线程
  ...
  - 进程：是程序的**一次执行过程**，是系统运行程序的**基本单位**
    ...
    - 以下为一个个的进程  
      ![lyx-20241126133623329](images/mypost/lyx-20241126133623329.png)
  ...
  - 请简要描述线程与进程的关系，区别及优缺点
    ...
    - 从JVM角度说明
      Java内存区域
      ![lyx-20241126133623877](images/mypost/lyx-20241126133623877.png)
...
- 说说线程的声明周期和状态
  ...
  - **TERMINATED**：终止状态，表示该线程**已经运行完毕**
    如图  
    ![lyx-20241126133624290](images/mypost/lyx-20241126133624290.png)
    对于该图有以下几点要注意：  
    ...
    1. 线程创建后处于**NEW**状态，之后调用**start()**方法运行，此时线程处于**READY**，可运行的线程获得CPU时间片（timeslice）后处于**RUNNING**状态
       ...
       >   ![lyx-20241126133624720](images/mypost/lyx-20241126133624720.png)
...
- 线程死锁是什么？如何避免?
  ...
  - 前提：**线程A持有资源2**，**线程B持有资源1**。现象：线程A在等待申请资源1，线程B在等待申请资源2，所以这两个线程就会**互相等待**而进入**死锁**状态
    ![lyx-20241126133625133](images/mypost/lyx-20241126133625133.png)
    使用代码描述上述问题
