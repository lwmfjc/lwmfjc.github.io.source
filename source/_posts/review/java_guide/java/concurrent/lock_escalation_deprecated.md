...
![image-20221031112225665](images/mypost/image-20221031112225665.png)
...
![image-20221031112946966](images/mypost/image-20221031112946966.png)

- 为什么每一个对象都可以成为一个锁
  markOop.hpp （对应对象标识）
  每一个java对象里面，有一个Monitor对象（ObjectMonitor.cpp)关联
  如图，_owner指向持有ObjectMonitor对象的线程
  ![image-20221031114235312](images/mypost/image-20221031114235312.png)
...
- ★★ 重点：Monitor与Java对象以及线程是如何关联
  ...
  - 图
    ![image-20221031132702183](images/mypost/image-20221031132702183.png)
...
- 偏向锁：单线程竞争
  ...
  - 意义：当一段同步代码，一直**被同一个线程**多次访问，由于**只有一个线程**那么该线程在后续访问时便会**自动获得锁**
    ![image-20221031172548988](images/mypost/image-20221031172548988.png)
...
- 一个**synchronized方法被一个线程抢到锁**时，这个方法所在的对象，就会在**其所在的MarkWord**中**将偏向锁修改状态位 
  ...
  - 如图  
    ![image-20221031174605461](images/mypost/image-20221031174605461.png)
